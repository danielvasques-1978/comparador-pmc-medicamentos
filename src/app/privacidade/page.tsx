  ...
  return (
    <main className="legal-shell">
      ...
      <section className="legal-panel">
        ...
        <p>E-mail, senha protegida por hash, favoritos, histórico de consultas, UF/ICMS escolhido e registros técnicos.</p>
        <h2>Finalidade</h2>
        <p>Salvar preferências, recuperar histórico, proteger a conta e preparar cobrança opcional futura.</p>
        <h2>Base legal</h2>
